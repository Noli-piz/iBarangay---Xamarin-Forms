...
namespace MobileApp
{
    ...
    public partial class ForgetPassword2 : ContentPage
    {
        ...
        public ForgetPassword2()
        {
            ...
            zsg_emailverification username = new zsg_emailverification();
            ...
            Console.WriteLine("ERROR: "+ randomNumber.randomNum());
        }
        ...
        async void OnButtonNext(object sender, EventArgs args)
        {
            ...
            {
                await Navigation.PushAsync(new ForgetPassword3());
            ...
            else
            {
                ...
                if (tries == 0)
                {
                    await this.DisplayAlert("Unable to Reset?", "Please go to Barangay Hall for this concern.", "OK");
