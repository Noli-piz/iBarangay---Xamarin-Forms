...
namespace MobileApp
{
    class zsg_hosting
    {
        ...
        private static String hosting1 = "http://localhost/iBarangay/";
        ...
        public zsg_hosting()
        {
            ...
            requestdelivered = hosting + "ibarangay_requestreceived.php";  //Req_Fragment5  // ?Username=
            ...
            getemail = hosting + "ibarangay_getemail.php";  //ForgetPassword
